...
class CraftMetaSkull extends CraftMetaItem implements SkullMeta {
    ...
    CraftMetaSkull(Map<String, Object> map) {
        ...
        if (this.noteBlockSound == null) {
            ...
            if (object instanceof NamespacedKey) {
                ...
                this.setNoteBlockSound(SerializableMeta.getObject(NamespacedKey.class, map, CraftMetaSkull.NOTE_BLOCK_SOUND.BUKKIT, true));
            }
        }
    }
    ...
    Builder<String, Object> serialize(Builder<String, Object> builder) {
        ...
        if (namespacedKeyNB != null) {
            return builder.put(CraftMetaSkull.NOTE_BLOCK_SOUND.BUKKIT, namespacedKeyNB);
        }
        return builder;
    }
