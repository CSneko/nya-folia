...
public class CraftMetaCompass extends CraftMetaItem implements CompassMeta {
    ...
    public Location getLodestone() {
        ...
        Optional<ResourceKey<net.minecraft.world.level.Level>> key = net.minecraft.world.level.Level.RESOURCE_KEY_CODEC.parse(NbtOps.INSTANCE, this.lodestoneWorld).result();
