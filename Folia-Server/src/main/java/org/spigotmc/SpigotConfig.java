...
public class SpigotConfig
{
    ...
    private static final String HEADER = "这是Spigot的主要配置文件\n"
            + "如您所见，有大量需要配置的内容。 某些选项可能会影响游戏玩法，因此请使用\n"
            + "请谨慎使用，并确保在配置之前了解每个选项的作用。\n"
            + "有关此文件中任何变量的参考，请查看 Spigot wiki：\n"
            + "http://www.spigotmc.org/wiki/spigot-configuration/\n"
            + "\n"
            + "如果您需要配置帮助或有任何与 Spigot 相关的问题,\n"
            + "加入我们的 Discord 或访问我们的论坛并发表帖子.\n"
            + "\n"
    ...
    public static void init(File configFile)
    {
        ...
        {
            Bukkit.getLogger().log( Level.SEVERE, "主人，spigot.yml 好像无法加载呢 ，请更正一下语法错误哦 ", ex );
