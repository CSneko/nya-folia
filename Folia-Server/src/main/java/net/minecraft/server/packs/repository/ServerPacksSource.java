...
public class ServerPacksSource extends BuiltInPackSource {
    ...
    public static PackRepository createPackRepository(Path dataPacksPath, DirectoryValidator directoryValidator) {
        return new PackRepository(new ServerPacksSource(directoryValidator), new FolderRepositorySource(dataPacksPath, PackType.SERVER_DATA, PackSource.WORLD, directoryValidator));
    }
